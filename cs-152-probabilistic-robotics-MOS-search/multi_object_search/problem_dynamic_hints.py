...
# @Date:   2022-03-22 12:57:22
# @Last Modified by:   Muhammad Umair
# @Last Modified time: 2022-04-13 13:46:03
...
def dynamic_hint(problem):
    ...
    target_state = problem.env.state.object_states[target_hint]; #groundtruth_pose = problem.env.state.pose(target_hint); 
    ...
    #print(target_hint, prior_of_target_hint, "\n")
    #p = problem.agent.cur_belief.object_beliefs[target_hint]
    #print(p, "\n")
    #print(target_state, "\n")
    #sys.exit(-1)
...
def solve(problem,
    ...
    for i in range(max_steps):
        # provide dynamic hint
        dynamic_hint(problem);
