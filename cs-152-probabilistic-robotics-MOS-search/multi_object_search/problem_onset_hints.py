...
# @Last Modified time: 2022-04-19 15:16:29
        ...
        if type(prior) == str:
            if prior == "uniform":
                ...
                for objid in env.target_objects:
                    ...
                    # change 1.0 to a trust variable later to match prior hints to trust threshold.
                    # or provide % or portion of total hints and keep some targets with unknown prior.
